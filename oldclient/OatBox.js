...
var OatBox = React.createClass({
  ...
  showWheat: function(){
    this.setState({showWhich: 'wheat'})
  },
  showGrain: function(){
    this.setState({showWhich: 'barley'})
  },
  render: function() {
    return (
            ...
            <div className="container">
              <div className="row">
                <div className="btn-group center-stuff">
                  <button onClick={this.showWheat} type="button" className="btn btn-secondary-outline stn-btn "><h5>wheat</h5></button>
                  <button onClick={this.showGrain} type="button" className="btn btn-secondary-outline stn-btn "><h5>barley</h5></button>
                </div>
              </div>
